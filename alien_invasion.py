...
class AlienInvasion():
    ...
    def _check_events(self):
        """Respond to keypress and and mouse events."""
    ...
    def _check_bullet_alien_collisions(self):
        ...
        collission = pygame.sprite.groupcollide(
    ...
    def _create_fleet(self):
        ...
        number_alien_x = available_space_x // (2*alien_widht)
    ...
    def _update_aliens(self):
        ...
        # Look for alien-ship colissions.
    ...
    def _check_fleet_edges(self):
        """Response appropriatelly if any alien have reached an edge."""
